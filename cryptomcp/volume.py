...
#:
#: Пороги подобраны по редкости, а не круглым числом: на 87 монетах с оборотом
#: от 10M кластер за трое суток нашёлся у шести (7%). Ослабление любого из трёх
...
#: монет из 87, с максимумом — у 6. Взят максимум, потому что у волатильной
#: монеты полпроцента — это шум, и «цена стоит» там означает другое число.
