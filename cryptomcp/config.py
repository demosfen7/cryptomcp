...
#: Применяется НЕ напрямую, а с потолком в длину канонического окна самого
#: таймфрейма — см. `analysis.duration_span_bar`. Без потолка требование в 180
#: суток на 4h, где окно даёт 102 суток у всех монет разом, было бы не
#: фильтром, а безусловным отказом.
