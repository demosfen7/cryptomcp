...
class TestSpecCases:
    ...
    Отдельно: порог оборота 2M делает `n/a` пять из шести случаев ТЗ (OAX на
    споте в 2024 — 0.65–1.72M в сутки, ASTER — 0.91M). В проде это не мешает:
    архивный универсум начинается с 3M.
    """
